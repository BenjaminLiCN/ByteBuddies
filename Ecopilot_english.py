...
# """, unsafe_allow_html=True)
with messageContainer.chat_message("assistant"):
    st.markdown("""🌟 **Hello! I am your intelligent financial analysis assistant, Ecopilot**
    
📊 Proficient in analyzing financial reports of global listed companies, financial modeling, and uncovering investment value

💡 I can help you with:
✅ Multi-dimensional interpretation of core financial data (financial health, business growth, industry competitiveness) \n
✅ In-depth analysis of a company's moat and potential risks \n
✅ Generating investment scenario simulations based on market dynamics \n
🕒 Supporting any time range (quarterly, annual, custom periods) \n
🏢 Currently, I have studied NVIDIA's stock prices and financial reports over the past 5 years. In the future, I will cover comprehensive historical stock prices, financial reports, and financial news data for US stocks, A-shares, and Hong Kong stocks. 

👇 Let me know your questions and I'll provide professional analysis
""", unsafe_allow_html=True)
    ...
    with messageContainer.chat_message("assistant"):
        try:
            ...
            with st.status("Thinking...", expanded=True) as status:
                ...
                message_placeholder.markdown(styled_keywords, unsafe_allow_html=True)
                status.update(label="Thinking finished!", state="complete", expanded=True)
